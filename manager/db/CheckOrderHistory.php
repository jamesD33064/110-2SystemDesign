<?php
    ...
    class Product{
        ...
        function set($IGname,$email,$ordername,$orderphone,$receverphone,$product_num_json,$payway,$sendway,$address,$sell_date,$id){
            $this->IGname = $IGname;
            $this->email = $email;
    ...
    if ($result) {
        ...
        if (mysqli_num_rows($result)>0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    $entity->set($row['IGname'],$row['email'],$row['ordername'],$row['orderphone'],$row['receverphone'],$row['product_num_json'],$row['payway'],$row['sendway'],$row['address'],$row['sell_date'],$id);
